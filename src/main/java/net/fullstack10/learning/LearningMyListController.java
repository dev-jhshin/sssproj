...
public class LearningMyListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.setAttribute("paging", CommonPageUtil.pagingArea(learningDAO.getLearningListSizeByMemberId(loginMemberId, map), cUtil.parseInt(pageNo), cUtil.parseInt(pageSize), cUtil.parseInt(pageBlockSize), "my_list.do?" + queryString));
