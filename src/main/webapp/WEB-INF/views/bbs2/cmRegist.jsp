	...
	<form name="frmRegist" method="post" action="regist.do" enctype="multipart/form-data">
		...
		<div class="form-section">
			...
			<div class="form-input">
				<input type="text" id="title" name="title" placeholder="100자 이내로 작성하세요." maxlength="100" required />
			</div>
		</div>
    ...
    <script>
      ...
      function updateFileList() {
        ...
        selectedFiles.forEach((file, index) => {
          ...
          fileName.textContent = file.name.substring(0, 10);
