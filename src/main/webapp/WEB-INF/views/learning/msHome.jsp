...
<body>
	...
	<div class="main-content">
		<div class="content-header">나의 학습</div>
		...
		<div class="search-section">
			...
			<div class="category-section">
				<div class="category-list-part">
					<div id="orderCreatedAtButton">등록 순</div>
					<div id="orderLikeCntButton">좋아요 순</div>
				</div>
				<span>
	...
	<script>
		...
		document.getElementById('cancelButton').addEventListener('click', () => {
			...
			window.location.href = "./my_list.do";
		});
		...
		// 등록순
		document.getElementById('orderCreatedAtButton').addEventListener('click', () => {
			const params = new URLSearchParams(window.location.search);
			params.set("orderColumn", "createdAt");
			window.location.href = "./my_list.do?"+ params.toString();
		});
		
		// 좋아요순
		document.getElementById('orderLikeCntButton').addEventListener('click', () => {
			const params = new URLSearchParams(window.location.search);
